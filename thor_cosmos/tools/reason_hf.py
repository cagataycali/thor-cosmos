"""Cosmos-Reason2 inference via HuggingFace Transformers (full-precision, x86)."""
...
def cosmos_reason_hf(
    ...
    the TRT-EdgeLLM server is not available. For Thor-deployed edge
    inference, use `cosmos_inference` (TRT server) instead.
    ...
    Args:
        ...
        return_image: if True, return the input image back in the response.
    """
    ...
    try:
        ...
        return err(
            f"missing deps: {e}. pip install transformers torch qwen-vl-utils",
        )
